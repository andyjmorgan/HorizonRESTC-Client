...
${nuget_cmd} install src/VMware.Horizon.RESTAPI/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/VMware.Horizon.RESTAPI.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/VMware.Horizon.RESTAPI.dll \
-recurse:'src/VMware.Horizon.RESTAPI/*.cs' \
-doc:bin/VMware.Horizon.RESTAPI.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/VMware.Horizon.RESTAPI.dll was created successfully"
fi
