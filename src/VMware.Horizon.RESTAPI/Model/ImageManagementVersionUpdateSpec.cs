...
namespace VMware.Horizon.RESTAPI.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ImageManagementVersionUpdateSpec :  IEquatable<ImageManagementVersionUpdateSpec>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ImageManagementVersionUpdateSpec" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ImageManagementVersionUpdateSpec() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ImageManagementVersionUpdateSpec" /> class.
        /// </summary>
        ...
        public ImageManagementVersionUpdateSpec(Dictionary<string, string> additionalDetails = default(Dictionary<string, string>), string description = default(string), string name = default(string), StatusEnum status = default(StatusEnum))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for ImageManagementVersionUpdateSpec and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (status == null)
            {
                throw new InvalidDataException("status is a required property for ImageManagementVersionUpdateSpec and cannot be null");
            }
            else
            {
                this.Status = status;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ImageManagementVersionUpdateSpec {\n");
        ...
        {
            return this.Equals(input as ImageManagementVersionUpdateSpec);
        }

        /// <summary>
        /// Returns true if ImageManagementVersionUpdateSpec instances are equal
        /// </summary>
        /// <param name="input">Instance of ImageManagementVersionUpdateSpec to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ImageManagementVersionUpdateSpec input)
        {
            if (input == null)
                return false;
