...
namespace VMware.Horizon.RESTAPI.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ViewComposerMonitorConnectionServer :  IEquatable<ViewComposerMonitorConnectionServer>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ViewComposerMonitorConnectionServer" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ViewComposerMonitorConnectionServer() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ViewComposerMonitorConnectionServer" /> class.
        /// </summary>
        ...
        public ViewComposerMonitorConnectionServer(CertificateMonitorInfo certificate = default(CertificateMonitorInfo), string id = default(string), string name = default(string), StatusEnum status = default(StatusEnum), bool? thumbprintAccepted = default(bool?))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for ViewComposerMonitorConnectionServer and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for ViewComposerMonitorConnectionServer and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (status == null)
            {
                throw new InvalidDataException("status is a required property for ViewComposerMonitorConnectionServer and cannot be null");
            }
            else
            {
                this.Status = status;
            ...
            {
                throw new InvalidDataException("thumbprintAccepted is a required property for ViewComposerMonitorConnectionServer and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ViewComposerMonitorConnectionServer {\n");
        ...
        {
            return this.Equals(input as ViewComposerMonitorConnectionServer);
        }

        /// <summary>
        /// Returns true if ViewComposerMonitorConnectionServer instances are equal
        /// </summary>
        /// <param name="input">Instance of ViewComposerMonitorConnectionServer to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ViewComposerMonitorConnectionServer input)
        {
            if (input == null)
                return false;
