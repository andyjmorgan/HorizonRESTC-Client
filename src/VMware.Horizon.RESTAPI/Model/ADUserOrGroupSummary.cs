...
namespace VMware.Horizon.RESTAPI.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ADUserOrGroupSummary :  IEquatable<ADUserOrGroupSummary>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ADUserOrGroupSummary" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ADUserOrGroupSummary() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ADUserOrGroupSummary" /> class.
        /// </summary>
        ...
        public ADUserOrGroupSummary(string container = default(string), string description = default(string), string displayName = default(string), string distinguishedName = default(string), string domain = default(string), string email = default(string), string firstName = default(string), bool? group = default(bool?), string guid = default(string), string id = default(string), bool? kioskUser = default(bool?), string lastName = default(string), string loginName = default(string), string longDisplayName = default(string), string name = default(string), string phone = default(string), string userDisplayName = default(string), string userPrincipalName = default(string))
        {
            // to ensure "domain" is required (not null)
            if (domain == null)
            {
                throw new InvalidDataException("domain is a required property for ADUserOrGroupSummary and cannot be null");
            }
            else
            {
                this.Domain = domain;
            ...
            if (group == null)
            {
                throw new InvalidDataException("group is a required property for ADUserOrGroupSummary and cannot be null");
            }
            else
            {
                this.Group = group;
            ...
            if (guid == null)
            {
                throw new InvalidDataException("guid is a required property for ADUserOrGroupSummary and cannot be null");
            }
            else
            {
                this.Guid = guid;
            ...
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for ADUserOrGroupSummary and cannot be null");
            }
            else
            {
                this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ADUserOrGroupSummary {\n");
        ...
        {
            return this.Equals(input as ADUserOrGroupSummary);
        }

        /// <summary>
        /// Returns true if ADUserOrGroupSummary instances are equal
        /// </summary>
        /// <param name="input">Instance of ADUserOrGroupSummary to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ADUserOrGroupSummary input)
        {
            if (input == null)
                return false;
