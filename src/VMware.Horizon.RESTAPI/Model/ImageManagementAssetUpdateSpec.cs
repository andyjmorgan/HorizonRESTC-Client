...
namespace VMware.Horizon.RESTAPI.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ImageManagementAssetUpdateSpec :  IEquatable<ImageManagementAssetUpdateSpec>, IValidatableObject
    {
        /// <summary>
        ...
        protected ImageManagementAssetUpdateSpec() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ImageManagementAssetUpdateSpec" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ImageManagementAssetUpdateSpec {\n");
        ...
        {
            return this.Equals(input as ImageManagementAssetUpdateSpec);
        }

        /// <summary>
        /// Returns true if ImageManagementAssetUpdateSpec instances are equal
        /// </summary>
        /// <param name="input">Instance of ImageManagementAssetUpdateSpec to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ImageManagementAssetUpdateSpec input)
        {
            if (input == null)
                return false;
