...
namespace VMware.Horizon.RESTAPI.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GatewayMonitorInfoV2 :  IEquatable<GatewayMonitorInfoV2>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GatewayMonitorInfoV2" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GatewayMonitorInfoV2() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GatewayMonitorInfoV2" /> class.
        /// </summary>
        ...
        public GatewayMonitorInfoV2(int? activeConnectionCount = default(int?), int? blastConnectionCount = default(int?), GatewayMonitorDetails details = default(GatewayMonitorDetails), string id = default(string), long? lastUpdatedTimestamp = default(long?), string name = default(string), int? pcoipConnectionCount = default(int?), StatusEnum status = default(StatusEnum))
        {
            // to ensure "details" is required (not null)
            if (details == null)
            {
                throw new InvalidDataException("details is a required property for GatewayMonitorInfoV2 and cannot be null");
            }
            else
            {
            ...
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for GatewayMonitorInfoV2 and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for GatewayMonitorInfoV2 and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (status == null)
            {
                throw new InvalidDataException("status is a required property for GatewayMonitorInfoV2 and cannot be null");
            }
            else
            {
                this.Status = status;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GatewayMonitorInfoV2 {\n");
        ...
        {
            return this.Equals(input as GatewayMonitorInfoV2);
        }

        /// <summary>
        /// Returns true if GatewayMonitorInfoV2 instances are equal
        /// </summary>
        /// <param name="input">Instance of GatewayMonitorInfoV2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GatewayMonitorInfoV2 input)
        {
            if (input == null)
                return false;
