...
namespace VMware.Horizon.RESTAPI.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GeneralSettingsUpdateSpec :  IEquatable<GeneralSettingsUpdateSpec>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GeneralSettingsUpdateSpec" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GeneralSettingsUpdateSpec() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GeneralSettingsUpdateSpec" /> class.
        /// </summary>
        ...
        /// <param name="clientIdleSessionTimeoutMinutes">Determines how long a user can be idle before the broker takes measure to protect the session..</param>
        ...
        /// <param name="clientMaxSessionTimeoutMinutes">Determines how long a user can keep a session open after logging in to the Connection Server. When a session times out, the session is terminated and the Horizon client is disconnected from the resource. This property has a default value of 600 and a minimum value of 5. This property is required if Client Max Session Timeout Policy is set to TIMEOUT_AFTER..</param>
        ...
        public GeneralSettingsUpdateSpec(int? applicationSsoTimeoutMinutes = default(int?), ApplicationSsoTimeoutPolicyEnum applicationSsoTimeoutPolicy = default(ApplicationSsoTimeoutPolicyEnum), bool? blockRestrictedClients = default(bool?), int? clientIdleSessionTimeoutMinutes = default(int?), ClientIdleSessionTimeoutPolicyEnum clientIdleSessionTimeoutPolicy = default(ClientIdleSessionTimeoutPolicyEnum), int? clientMaxSessionTimeoutMinutes = default(int?), ClientMaxSessionTimeoutPolicyEnum clientMaxSessionTimeoutPolicy = default(ClientMaxSessionTimeoutPolicyEnum), int? clientSessionTimeoutMinutes = default(int?), int? consoleSessionTimeoutMinutes = default(int?), bool? displayPreLoginMessage = default(bool?), bool? displayWarningBeforeForcedLogoff = default(bool?), bool? enableAutomaticStatusUpdates = default(bool?), bool? enableCredentialCleanupForHtmlaccess = default(bool?), bool? enableMultiFactorReAuthentication = default(bool?), bool? enableSendingDomainList = default(bool?), bool? enableServerInSingleUserMode = default(bool?), string forcedLogoffMessage = default(string), int? forcedLogoffTimeoutMinutes = default(int?), bool? hideDomainListInClient = default(bool?), bool? hideServerInformationInClient = default(bool?), int? machineSsoTimeoutMinutes = default(int?), MachineSsoTimeoutPolicyEnum machineSsoTimeoutPolicy = default(MachineSsoTimeoutPolicyEnum), string preLoginMessage = default(string), List<RestrictedClientData> restrictedClientData = default(List<RestrictedClientData>), string restrictedClientMessage = default(string), bool? storeCalOnClient = default(bool?), bool? storeCalOnConnectionServer = default(bool?))
        {
            ...
            {
                throw new InvalidDataException("clientIdleSessionTimeoutPolicy is a required property for GeneralSettingsUpdateSpec and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("clientMaxSessionTimeoutPolicy is a required property for GeneralSettingsUpdateSpec and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("clientSessionTimeoutMinutes is a required property for GeneralSettingsUpdateSpec and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("machineSsoTimeoutPolicy is a required property for GeneralSettingsUpdateSpec and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("storeCalOnClient is a required property for GeneralSettingsUpdateSpec and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("storeCalOnConnectionServer is a required property for GeneralSettingsUpdateSpec and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>Determines how long a user can be idle before the broker takes measure to protect the session.</value>
        ...
        /// </summary>
        /// <value>Determines how long a user can keep a session open after logging in to the Connection Server. When a session times out, the session is terminated and the Horizon client is disconnected from the resource. This property has a default value of 600 and a minimum value of 5. This property is required if Client Max Session Timeout Policy is set to TIMEOUT_AFTER.</value>
        ...
        /// </summary>
        /// <value>Determines whether or not to store the RDS Per Device Client Access License on Broker.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GeneralSettingsUpdateSpec {\n");
        ...
        {
            return this.Equals(input as GeneralSettingsUpdateSpec);
        }

        /// <summary>
        /// Returns true if GeneralSettingsUpdateSpec instances are equal
        /// </summary>
        /// <param name="input">Instance of GeneralSettingsUpdateSpec to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GeneralSettingsUpdateSpec input)
        {
            if (input == null)
                return false;
