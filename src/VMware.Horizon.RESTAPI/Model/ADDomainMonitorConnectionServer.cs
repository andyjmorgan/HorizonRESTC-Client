...
namespace VMware.Horizon.RESTAPI.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ADDomainMonitorConnectionServer :  IEquatable<ADDomainMonitorConnectionServer>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ADDomainMonitorConnectionServer" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ADDomainMonitorConnectionServer() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ADDomainMonitorConnectionServer" /> class.
        /// </summary>
        ...
        public ADDomainMonitorConnectionServer(string id = default(string), string name = default(string), StatusEnum status = default(StatusEnum), TrustRelationshipEnum trustRelationship = default(TrustRelationshipEnum))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for ADDomainMonitorConnectionServer and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for ADDomainMonitorConnectionServer and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (status == null)
            {
                throw new InvalidDataException("status is a required property for ADDomainMonitorConnectionServer and cannot be null");
            }
            else
            {
                this.Status = status;
            ...
            {
                throw new InvalidDataException("trustRelationship is a required property for ADDomainMonitorConnectionServer and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ADDomainMonitorConnectionServer {\n");
        ...
        {
            return this.Equals(input as ADDomainMonitorConnectionServer);
        }

        /// <summary>
        /// Returns true if ADDomainMonitorConnectionServer instances are equal
        /// </summary>
        /// <param name="input">Instance of ADDomainMonitorConnectionServer to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ADDomainMonitorConnectionServer input)
        {
            if (input == null)
                return false;
