...
namespace VMware.Horizon.RESTAPI.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DesktopPoolSessionSettings :  IEquatable<DesktopPoolSessionSettings>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DesktopPoolSessionSettings" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DesktopPoolSessionSettings() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DesktopPoolSessionSettings" /> class.
        /// </summary>
        ...
        public DesktopPoolSessionSettings(bool? allowMultipleSessionsPerUser = default(bool?), bool? allowUsersToResetMachines = default(bool?), DeleteOrRefreshMachineAfterLogoffEnum deleteOrRefreshMachineAfterLogoff = default(DeleteOrRefreshMachineAfterLogoffEnum), int? disconnectedSessionTimeoutMinutes = default(int?), DisconnectedSessionTimeoutPolicyEnum disconnectedSessionTimeoutPolicy = default(DisconnectedSessionTimeoutPolicyEnum), int? emptySessionTimeoutMinutes = default(int?), EmptySessionTimeoutPolicyEnum emptySessionTimeoutPolicy = default(EmptySessionTimeoutPolicyEnum), bool? logoffAfterTimeout = default(bool?), PowerPolicyEnum powerPolicy = default(PowerPolicyEnum), RefreshOsDiskAfterLogoffEnum refreshOsDiskAfterLogoff = default(RefreshOsDiskAfterLogoffEnum), int? refreshPeriodDaysForReplicaOsDisk = default(int?), int? refreshThresholdPercentageForReplicaOsDisk = default(int?))
        {
            ...
            {
                throw new InvalidDataException("allowUsersToResetMachines is a required property for DesktopPoolSessionSettings and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("deleteOrRefreshMachineAfterLogoff is a required property for DesktopPoolSessionSettings and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("disconnectedSessionTimeoutPolicy is a required property for DesktopPoolSessionSettings and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("emptySessionTimeoutPolicy is a required property for DesktopPoolSessionSettings and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("logoffAfterTimeout is a required property for DesktopPoolSessionSettings and cannot be null");
            }
            else
            {
            ...
            if (powerPolicy == null)
            {
                throw new InvalidDataException("powerPolicy is a required property for DesktopPoolSessionSettings and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("refreshOsDiskAfterLogoff is a required property for DesktopPoolSessionSettings and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("refreshPeriodDaysForReplicaOsDisk is a required property for DesktopPoolSessionSettings and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("refreshThresholdPercentageForReplicaOsDisk is a required property for DesktopPoolSessionSettings and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DesktopPoolSessionSettings {\n");
        ...
        {
            return this.Equals(input as DesktopPoolSessionSettings);
        }

        /// <summary>
        /// Returns true if DesktopPoolSessionSettings instances are equal
        /// </summary>
        /// <param name="input">Instance of DesktopPoolSessionSettings to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DesktopPoolSessionSettings input)
        {
            if (input == null)
                return false;
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // RefreshPeriodDaysForReplicaOsDisk (int?) minimum
            if(this.RefreshPeriodDaysForReplicaOsDisk < (int?)1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for RefreshPeriodDaysForReplicaOsDisk, must be a value greater than or equal to 1.", new [] { "RefreshPeriodDaysForReplicaOsDisk" });
            }
