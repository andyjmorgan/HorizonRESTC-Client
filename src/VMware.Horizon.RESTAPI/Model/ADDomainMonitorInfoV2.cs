...
namespace VMware.Horizon.RESTAPI.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ADDomainMonitorInfoV2 :  IEquatable<ADDomainMonitorInfoV2>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ADDomainMonitorInfoV2" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ADDomainMonitorInfoV2() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ADDomainMonitorInfoV2" /> class.
        /// </summary>
        ...
        public ADDomainMonitorInfoV2(List<ADDomainMonitorConnectionServerV2> connectionServers = default(List<ADDomainMonitorConnectionServerV2>), string dnsName = default(string), string netbiosName = default(string), bool? nt4Domain = default(bool?))
        {
            // to ensure "dnsName" is required (not null)
            if (dnsName == null)
            {
                throw new InvalidDataException("dnsName is a required property for ADDomainMonitorInfoV2 and cannot be null");
            }
            else
            {
            ...
            if (netbiosName == null)
            {
                throw new InvalidDataException("netbiosName is a required property for ADDomainMonitorInfoV2 and cannot be null");
            }
            else
            {
            ...
            if (nt4Domain == null)
            {
                throw new InvalidDataException("nt4Domain is a required property for ADDomainMonitorInfoV2 and cannot be null");
            }
            else
            {
        ...
        public List<ADDomainMonitorConnectionServerV2> ConnectionServers { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ADDomainMonitorInfoV2 {\n");
        ...
        {
            return this.Equals(input as ADDomainMonitorInfoV2);
        }

        /// <summary>
        /// Returns true if ADDomainMonitorInfoV2 instances are equal
        /// </summary>
        /// <param name="input">Instance of ADDomainMonitorInfoV2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ADDomainMonitorInfoV2 input)
        {
            if (input == null)
                return false;
