...
namespace VMware.Horizon.RESTAPI.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ImageManagementAssetInfo :  IEquatable<ImageManagementAssetInfo>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ImageManagementAssetInfo" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ImageManagementAssetInfo() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ImageManagementAssetInfo" /> class.
        /// </summary>
        /// <param name="additionalDetails">Additional details about image management asset..</param>
        /// <param name="baseSnapshotId">Virtual machine snapshot. Must be set if vm_template_id is unset. (required).</param>
        /// <param name="baseVmId">Virtual machine ID. Must be set if vm_template_id is unset. (required).</param>
        ...
        /// <param name="datacenterId">Datacenter where this asset is created. (required).</param>
        /// <param name="id">Unique ID representing image management asset. (required).</param>
        ...
        /// <param name="vmTemplateId">Virtual machine template ID. (required).</param>
        public ImageManagementAssetInfo(Dictionary<string, string> additionalDetails = default(Dictionary<string, string>), string baseSnapshotId = default(string), string baseVmId = default(string), CloneTypeEnum cloneType = default(CloneTypeEnum), string datacenterId = default(string), string id = default(string), string imStreamId = default(string), string imVersionId = default(string), ImageTypeEnum imageType = default(ImageTypeEnum), StatusEnum status = default(StatusEnum), string vcenterId = default(string), string vmTemplateId = default(string))
        {
            // to ensure "baseSnapshotId" is required (not null)
            if (baseSnapshotId == null)
            {
                throw new InvalidDataException("baseSnapshotId is a required property for ImageManagementAssetInfo and cannot be null");
            }
            else
            {
                this.BaseSnapshotId = baseSnapshotId;
            }
            // to ensure "baseVmId" is required (not null)
            if (baseVmId == null)
            {
                throw new InvalidDataException("baseVmId is a required property for ImageManagementAssetInfo and cannot be null");
            }
            else
            {
            ...
            if (cloneType == null)
            {
                throw new InvalidDataException("cloneType is a required property for ImageManagementAssetInfo and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("datacenterId is a required property for ImageManagementAssetInfo and cannot be null");
            }
            else
            {
            ...
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for ImageManagementAssetInfo and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (imStreamId == null)
            {
                throw new InvalidDataException("imStreamId is a required property for ImageManagementAssetInfo and cannot be null");
            }
            else
            {
            ...
            if (imVersionId == null)
            {
                throw new InvalidDataException("imVersionId is a required property for ImageManagementAssetInfo and cannot be null");
            }
            else
            {
            ...
            if (imageType == null)
            {
                throw new InvalidDataException("imageType is a required property for ImageManagementAssetInfo and cannot be null");
            }
            else
            {
            ...
            if (status == null)
            {
                throw new InvalidDataException("status is a required property for ImageManagementAssetInfo and cannot be null");
            }
            else
            {
                this.Status = status;
            ...
            if (vcenterId == null)
            {
                throw new InvalidDataException("vcenterId is a required property for ImageManagementAssetInfo and cannot be null");
            }
            else
            {
                this.VcenterId = vcenterId;
            }
            // to ensure "vmTemplateId" is required (not null)
            if (vmTemplateId == null)
            {
                throw new InvalidDataException("vmTemplateId is a required property for ImageManagementAssetInfo and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>Datacenter where this asset is created.</value>
        ...
        /// </summary>
        /// <value>Unique ID representing image management asset.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ImageManagementAssetInfo {\n");
        ...
        {
            return this.Equals(input as ImageManagementAssetInfo);
        }

        /// <summary>
        /// Returns true if ImageManagementAssetInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of ImageManagementAssetInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ImageManagementAssetInfo input)
        {
            if (input == null)
                return false;
