...
namespace VMware.Horizon.RESTAPI.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConnectionServerMonitorInfoV2 :  IEquatable<ConnectionServerMonitorInfoV2>, IValidatableObject
    {
        /// <summary>
        ...
        protected ConnectionServerMonitorInfoV2() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ConnectionServerMonitorInfoV2" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ConnectionServerMonitorInfoV2 {\n");
        ...
        {
            return this.Equals(input as ConnectionServerMonitorInfoV2);
        }

        /// <summary>
        /// Returns true if ConnectionServerMonitorInfoV2 instances are equal
        /// </summary>
        /// <param name="input">Instance of ConnectionServerMonitorInfoV2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConnectionServerMonitorInfoV2 input)
        {
            if (input == null)
                return false;
