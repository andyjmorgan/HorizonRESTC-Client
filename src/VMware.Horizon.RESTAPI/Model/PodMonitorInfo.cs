...
namespace VMware.Horizon.RESTAPI.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PodMonitorInfo :  IEquatable<PodMonitorInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PodMonitorInfo" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PodMonitorInfo() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PodMonitorInfo" /> class.
        /// </summary>
        ...
        public PodMonitorInfo(List<PodEndPointData> endpoints = default(List<PodEndPointData>), string id = default(string), string name = default(string), string siteId = default(string))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for PodMonitorInfo and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for PodMonitorInfo and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (siteId == null)
            {
                throw new InvalidDataException("siteId is a required property for PodMonitorInfo and cannot be null");
            }
            else
            {
                this.SiteId = siteId;
        ...
        public List<PodEndPointData> Endpoints { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PodMonitorInfo {\n");
        ...
        {
            return this.Equals(input as PodMonitorInfo);
        }

        /// <summary>
        /// Returns true if PodMonitorInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of PodMonitorInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PodMonitorInfo input)
        {
            if (input == null)
                return false;
