...
namespace VMware.Horizon.RESTAPI.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DesktopPoolDisplayProtocolSettings :  IEquatable<DesktopPoolDisplayProtocolSettings>, IValidatableObject
    {
        /// <summary>
        ...
        {
            // MaxNumberOfMonitors (int?) maximum
            if(this.MaxNumberOfMonitors > (int?)4)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for MaxNumberOfMonitors, must be a value less than or equal to 4.", new [] { "MaxNumberOfMonitors" });
            }

            // MaxNumberOfMonitors (int?) minimum
            if(this.MaxNumberOfMonitors < (int?)1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for MaxNumberOfMonitors, must be a value greater than or equal to 1.", new [] { "MaxNumberOfMonitors" });
            }

            // VramSizeMb (int?) maximum
            if(this.VramSizeMb > (int?)512)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for VramSizeMb, must be a value less than or equal to 512.", new [] { "VramSizeMb" });
            }

            // VramSizeMb (int?) minimum
            if(this.VramSizeMb < (int?)64)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for VramSizeMb, must be a value greater than or equal to 64.", new [] { "VramSizeMb" });
            }
